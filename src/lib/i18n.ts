...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    /* Hero */
    'hero.badge': 'AI interview practice · Technical & Behavioral · Voice support · Study Plans · EN / RU',
    'hero.title': 'Ace Your Next {role} with AI',
    'hero.title_highlight': 'Tech Interview',
    'hero.subtitle': 'Upload your resume, get AI-generated questions tailored to any role and experience level. Practice both technical and behavioral (STAR method) interviews. Get instant scoring, track your progress, and receive personalized AI study plans — all in one place. Available in English and Russian.',
    ...
    'features.tracking.title': 'Progress Tracking & AI Study Plans',
    'features.tracking.desc': 'Track scores over time, identify weak spots, and revisit past sessions. Generate a personalized AI study plan based on your actual interview performance — focus on what you need to improve, not generic advice.',
    ...
    'how.step3.desc': 'Receive a final score out of 100, breakdown by question, and tailored recommendations. Generate a personalized AI study plan to systematically improve your weakest areas over days or weeks.',
    ...
    'about.what.p': 'AI Interview Trainer is an AI-powered platform that simulates real technical interviews via Telegram. Powered by <strong>OpenAI GPT-4o</strong>, our system generates fresh, role-specific questions, evaluates your answers in depth, and gives you actionable feedback — instantly. Use your results to generate a personalized AI study plan that turns weak spots into a structured learning path. Premium subscribers unlock <strong>GPT-5.4</strong> — our most advanced model for deeper analysis. You can also prepare for interviews at specific companies: add a vacancy URL and get questions tailored to that role and company culture.',
    ...
    'about.feature5.title': 'Progress Tracking & AI Study Plans',
    'about.feature5.body': 'Track your scores over time, spot weak areas, and see measurable improvement. Generate a personalized AI study plan based on your interview performance — get a day-by-day curriculum tailored to your gaps.',
  ...
  ru: {
    ...
    /* Hero */
    'hero.badge': 'AI практика интервью · Technical & Behavioral · Голосовая поддержка · Планы обучения · EN / RU',
    'hero.title': 'Пройди {role} с AI',
    'hero.title_highlight': 'Tech Interview',
    'hero.subtitle': 'Загрузи резюме, получи AI-сгенерированные вопросы под любую роль и уровень. Практикуй технические и поведенческие (метод STAR) интервью. Получай мгновенные оценки, отслеживай прогресс и создавай персонализированные AI-планы обучения — всё в одном месте. Доступно на английском и русском.',
    ...
    'features.tracking.title': 'Прогресс и AI-планы обучения',
    'features.tracking.desc': 'Отслеживай баллы, определяй слабые места и возвращайся к прошлым сессиям. Создавай персонализированный AI-план обучения на основе реальных результатов интервью — сосредоточься на том, что действительно нужно улучшить.',
    ...
    'how.step3.desc': 'Получи итоговый балл из 100, разбор по каждому вопросу и персонализированные рекомендации. Создай AI-план обучения, чтобы системно прокачать слабые места за дни или недели.',
    ...
    'about.what.p': 'AI Interview Trainer — это AI-платформа, которая симулирует реальные технические собеседования через Telegram. Работает на базе <strong>OpenAI GPT-4o</strong>. Наша система генерирует новые вопросы по конкретным ролям, глубоко оценивает ответы и даёт практичную обратную связь — мгновенно. Используй результаты для создания персонализированного AI-плана обучения, который превращает слабые места в структурированную программу. Подписчики Premium получают доступ к <strong>GPT-5.4</strong> — нашей самой продвинутой модели для более глубокого анализа. Также вы можете готовиться к собеседованиям в конкретных компаниях: добавьте ссылку на вакансию и получите вопросы под эту роль и культуру компании.',
    ...
    'about.feature5.title': 'Прогресс и AI-планы обучения',
    'about.feature5.body': 'Отслеживай баллы, определяй слабые места и наблюдай измеримый прогресс. Создавай персонализированный AI-план обучения на основе результатов интервью — получи пошаговую программу, заточенную под твои пробелы.',
